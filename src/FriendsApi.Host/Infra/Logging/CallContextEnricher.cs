    ...
    public class CallContextEnricher : ILogEventEnricher
    {
        ...
        public void Enrich(LogEvent logEvent, ILogEventPropertyFactory propertyFactory)
        {
            if (_httpContextAccessor.HttpContext != null)
            {
                ...
                logEvent.AddPropertyIfAbsent(propertyFactory.CreateProperty("RequestPath", logEvent.Properties["RequestPath"].ToString().Trim('"')));
                ...
                if (logEvent.Properties.ContainsKey("SourceContext"))
                    logEvent.AddPropertyIfAbsent(propertyFactory.CreateProperty("SourceContext", logEvent.Properties["SourceContext"].ToString().Trim('"')));
            }
        }
    }
}